...
function StartWorkout() {
  ...
  const handleMarkAsDone = () => {
    if (!setsExercise.toString() || !repsExercise.toString()) {
      toast.error(
        "Please enter complete information before go to the next exercise!"
      );
    } else {
      setMarkDone(true);
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className={styleStartWorkout.startWorkoutContent}>
          <ArrowBackIcon
            sx={{
              fontSize: "50px",
              color: "#10cd98",
                        ...
                        return (
                          <tr className={styleStartWorkout.trResult}>
                            ...
                            <td
                              ...
                              style={{
                                color:
                                  Number(item.setsExerciseUser) >=
                                  Number(item.setsExerciseWorkout)
                                    ? "green"
                                    : "red",
                              }}
                            >
                            ...
                            <td
                              ...
                              style={{
                                color:
                                  Number(item.repsExerciseUser) >=
                                  Number(item.repsExerciseWorkout)
                                    ? "green"
                                    : "red",
                              }}
                            >
                    ...
                    >
                      <Box sx={styleModal}>
                        <Typography
                          ...
                          component="h2"
                        >
                          Please enter complete information below before go to
                          the next exercise! How many sets and reps could you do
                          in this exercise ?
                        </Typography>
                        <TextField
                          id="outlined-basic"
